...
cp -r vendor/pixen/utils/emulator/skins $ANDROID_PRODUCT_OUT
cp -r vendor/pixen/utils/emulator/start_emulator_image.sh $ANDROID_PRODUCT_OUT
cp -r vendor/pixen/utils/emulator/advancedFeatures.ini $ANDROID_PRODUCT_OUT
