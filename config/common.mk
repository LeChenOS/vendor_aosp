...
# OTA
#dont-🤔include vendor/aosp/config/ota.mk
...
#permissions
PRODUCT_COPY_FILES += \
    vendor/aosp/prebuilt/etc/permissions/privapp-permissions-omni.xml:system/etc/permissions/privapp-permissions-omni.xml 
